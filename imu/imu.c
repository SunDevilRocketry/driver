/**
  ******************************************************************************
  * @file           : imu.c
  * @brief          : Unified IMU System Translation Implementation
  * @author         : Sun Devil Rocketry Firmware Team
  *
  * @note  Statically compiled translation layer. This file uses preprocessor
  *        directives to compile the correct configuration, scaling, and
  *        retrieval pipelines based on the targeted flight computer board.
  *
  ******************************************************************************
  * @attention
